...
excitations. If $p\sim N^1$, the scaling law is
$$
...
The heterotic CP models in two dimensions are of great interest on their own. For instance, 
heterotically deformed weighted 
CP models with twisted masses exhibit even a richer phase diagram with highly nontrivial phases.
The study of these models in the large-$N$ limit is in full swing now \cite{last}.

\section{Erratum}

There is a typographical error in Eq. (C8). This equation should coincide with (E27).

Equation (E27) was obtained from normalization of the $\bar\zeta i\partial_L\zeta$ term
in the first line in the first (unnumbered) equation on page 9 of \cite{onea} (normalization to unity). 
The coefficient of this term was not established to order $O(\delta^2)$; the absence of $O(\delta^2)$ was not verified. 
...
P.~A.~Bolokhov, M.~Shifman and A.~Yung,
 ...
 P.~A.~Bolokhov, M.~Shifman and A.~Yung,
  ...
  %6 citations counted in INSPIRE as of 07 Jan 2014
...
\bibitem{Olmez}
  ...
  Phys.\ Rev.\ D {\bf 82}, 125023 (2010)
  [arXiv:1009.6207 [hep-th]];
  %%CITATION = ARXIV:1009.6207;%%
  %5 citations counted in INSPIRE as of 07 Jan 2014
  
   P.~Koroteev and A.~Monin,
  %``Large-N Solution of the Heterotic N=(0,1) Two-Dimensional O(N) Sigma Model,''
  Phys.\ Rev.\ D {\bf 81}, 105001 (2010)
  [arXiv:1003.2645 [hep-th]].
  %%CITATION = ARXIV:1003.2645;%%
  %2 citations counted in INSPIRE as of 07 Jan 2014
  
   
\bibitem{onea}
 P.~A.~Bolokhov, M.~Shifman and A.~Yung,
  %``Description of the Heterotic String Solutions in U(N) SQCD,''
  Phys.\ Rev.\ D {\bf 79}, 085015 (2009)
  [arXiv:0901.4603 [hep-th]].
  %%CITATION = ARXIV:0901.4603;%%
  %10 citations counted in INSPIRE as of 23 Dec 2013
  
\bibitem{twoa}
J. Chen, X. Cui, M. Shifman, and A. Vainshtein, to be published.
