...
and the mass terms (see Apendix \ref{app:symm} for detailes). 
...
of  real and positive $m$. Sometimes however, we will relax this conition.
...
&+&
 ...
 \label{deforte}
\eeqn
where $\omega$ is a deformation parameter.
...
is given\,\footnote{Equation (\ref{tftpi4}) shows that $\delta$ and $\tilde\gamma$ 
...
\caption{\small Vacuum energy density vs. $m$. The dashed lines denote the boundaries between three distinct
phases.}
\label{figvacE}
\end{figure}
